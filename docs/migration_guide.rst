...
2. Added (SNIP-9)[https://github.com/starknet-io/SNIPs/blob/main/SNIPS/snip-9.md] support to :class:`account.account.Account`. Now it's possible to create a :class:`client_models.Call` for outside execution using :meth:`account.account.Account.sign_outside_execution_call`.
