...
2. New methods have been added: :meth:`~FullNodeClient.get_storage_proof`, :meth:`~FullNodeClient.get_storage_proof_v2` and :meth:`~FullNodeClient.get_compiled_casm`.
