...
.. warning::
    You might encounter problems related to ``libcrypto_c_exports`` (e.g  LoadLibraryEx).
    Install via chocolatey and set proper PATH for it should solve your problem.
