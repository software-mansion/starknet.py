...
.. codesnippet:: ../../starknet_py/tests/docs/guide/test_custom_signer.py
    :language: python
    :dedent: 4
...
.. codesnippet:: ../../starknet_py/tests/docs/guide/test_sign_offchain_message.py
    :language: python
    :dedent: 4
...
.. codesnippet:: ../../starknet_py/tests/docs/guide/test_sign_for_fee_estimate.py
    :language: python
    :dedent: 4
