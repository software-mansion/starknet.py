...
:obj:`AbiParser <starknet_py.net.models.abi.v0.parser.AbiParser>` transforms ABI into
:obj:`Abi dataclass <starknet_py.net.models.abi.v0.model.Abi>` that can be used for creating serializers. This way you can
