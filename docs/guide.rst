...
CairoSerializer can be used to transform any data (like a function call or an event). It requires an abi of the contract, types of values and data to be serialized.
