...
from starknet_py.contract.contract import SentTransaction
...
class AccountDeploymentResult(SentTransaction):
    """
    Result of the :meth:`Account.deploy_account <starknet_py.client.account.account.Account.deploy_account>` method.
    """
