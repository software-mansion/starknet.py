...
from starknet_py.client.models.call import Call, Calls
from starknet_py.client.models.contract import DeclaredContract
from starknet_py.client.models.fee import EstimatedFee
from starknet_py.client.models.response import (
...
class AccountClient(Client):
    """
    Extends the functionality of :obj:`Client <starknet_py.client.client.Client>`,
    ...
    def __init__(
        ...
        :param signer: Custom signer to be used by AccountClient.
                       ...
                       :py:class:`starknet_py.client.signer.stark_curve_signer.StarkCurveSigner` is used.
    ...
    def _get_default_token_address(self) -> str:
        if self.net not in [TESTNET, TESTNET2, MAINNET]:
            raise ValueError(
                "Argument token_address must be specified when using a custom client address."
            )
