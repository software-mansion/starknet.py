...
async def test_declaring_contracts(
    ...
    resource_bounds = ResourceBoundsMapping(
        l1_gas=ResourceBounds(max_amount=int(1e18), max_price_per_unit=int(1e35)),
        l2_gas=ResourceBounds(max_amount=int(1e18), max_price_per_unit=int(1e35)),
        l1_data_gas=ResourceBounds(max_amount=int(1e18), max_price_per_unit=int(1e35)),
    )
