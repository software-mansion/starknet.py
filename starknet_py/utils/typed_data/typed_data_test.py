...
from starknet_py.utils.typed_data.typed_data import TypedData
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # (TD_FELT_ARR, "Mail", "message", "0x26186b02dddb59bf12114f771971b818f48fad83c373534abebaaa39b63a7ce"),  # FIX
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # (TD_FELT_ARR, "0xcd2a3d9f938e13cd947ec05abc7fe734df8dd826", "0x30ab43ef724b08c3b0a9bbe425e47c6173470be75d1d4c55fd5bf9309896bce"),  # FIX
