...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CasesRev1.TD_PRESET_TYPES.value, "Example", "0x1a25a8bb84b761090b1fadaebe762c4b679b0d8883d2bedda695ea340839a55"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CasesRev1.TD_PRESET_TYPES.value, "Example", "message",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CasesRev1.TD_PRESET_TYPES.value, "0xcd2a3d9f938e13cd947ec05abc7fe734df8dd826",
...
def test_basic_types_redefinition(included_type: str, revision: Revision):
    with pytest.raises(ValueError, match=fr"Types must not contain basic types. \[{included_type}\] was found."):
        _make_typed_data(included_type, revision)
...
@pytest.mark.parametrize(
    "included_type, revision",
    [
        (PresetType.U256.value, Revision.V1),
        (PresetType.TOKEN_AMOUNT.value, Revision.V1),
        (PresetType.NFT_ID.value, Revision.V1),
    ],
)
def test_preset_types_redefinition(included_type: str, revision: Revision):
    with pytest.raises(ValueError, match=fr"Types must not contain preset types. \[{included_type}\] was found."):
        _make_typed_data(included_type, revision)
