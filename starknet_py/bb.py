...
#
# # async def _create_block(devnet_client: DevnetClient) -> Union[StarknetBlock, PendingStarknetBlock]:
# #     new_block_hash = await devnet_client.create_block()
# #     new_block = await devnet_client.get_block(block_hash=new_block_hash)
# #     return new_block
#
#
# @pytest.mark.asyncio
...
#     [
#         (None, None),
#         (0x07098C2B7ED93AFEF802B7660231CF74413D93E63C23C69CA981C1B76537DE91, None),
#         ("latest", None),
#         (None, 643403),
#     ],
# )
...
#         handler=handler, block_hash=block_hash, block_number=block_number
#     )
#
...
# ):
#     def handler(_new_heads_notification: NewHeadsNotification):
#         pass
#
#     with pytest.raises(
#         ValueError,
...
#             handler=handler, block_hash=1, block_number=1
#         )
#
#
# @pytest.mark.asyncio
...
#     latest_block_number = (await client.get_block(block_hash="latest")).block_number
#     assert latest_block_number >= 1025
#
#     def handler(_new_heads_notification: NewHeadsNotification):
#         pass
#
#     # TODO(#1498): Ensure if it shouldn't be TOO_MANY_BLOCKS_BACK error.
#     query_block_number = latest_block_number - 1025
#     with pytest.raises(
#         WebsocketClientError,
#         match="WebsocketClient failed with code 24. Message: Block not found.",
#     ):
#         await websocket_client.subscribe_new_heads(
#             handler=handler, block_number=query_block_number
#         )
#
#
# @pytest.mark.asyncio
